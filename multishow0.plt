...
#==============================================================================
plot \
    'plot0.dat' index 0 title 'sin(x)' with lines linestyle 1 linewidth 2, \
    'plot0.dat' index 1 title 'sin(2x)' with lines linestyle 2 linewidth 2, \
    'plot0.dat' index 2 title 'sin(3x)' with lines linestyle 3 linewidth 2, \
    'plot0.dat' index 3 title 'sin(4x)' with lines linestyle 4 linewidth 2, \
    'plot0.dat' index 4 title 'sin(5x)' with lines linestyle 5 linewidth 2, \
    'plot0.dat' index 5 title 'sin(6x)' with lines linestyle 6 linewidth 2
